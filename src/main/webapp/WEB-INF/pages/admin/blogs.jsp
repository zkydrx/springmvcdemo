...
<div class="container">
    ...
    <form id="forContent" action="/admin/blogs/showUsersBlogs" method="get">
        <input type="text" id="byContent" name="byContent" value=""  PLACEHOLDER="Please input the content"/>
            ...
            <c:forEach items="${blogList}" var="blog">
                <tr>
                    ...
                    <td>
                        ...
                        <a href="/admin/blogs/update/${blog.id}" type="button" class="btn btn-sm btn-success">修改</a>
                        <a href="/admin/blogs/delete/${blog.id}" type="button" class="btn btn-sm btn-success">删除</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
