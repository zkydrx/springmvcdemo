...
<div class="container">
    ...
    <form:form action="/admin/blogs/updateP" method="post" commandName="blogP" role="form">
        ...
        <div class="form-group">
            ...
            <textarea type="text" class="form-control" id="content" name="content" rows="3" placeholder="Please Input Content:" >${blog.content}</textarea>
        </div>
        <div class="form-group">
            <label for="pubDate">Publish Date:</label>
            <input type="text" class="form-control" id="pubDate" name="pubDate" value="<ftm:formatDate value="${blog.pubDate}" pattern="yyyy-MM-dd"/>"/>
